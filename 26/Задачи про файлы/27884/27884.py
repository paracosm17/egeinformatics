...
# (натуральное число, не превышающее 10 000) и N — количество пользователей (натуральное число, не превышающее 4000). 
...
# https://inf-ege.sdamgia.ru/problem?id=27884

# Всё то же, что и в 26 (1)
files = sorted(list(map(int, open("27884.txt", "r").read().splitlines()[1:])))
size = int(open("27884.txt", "r").readline().split(" ")[0])
